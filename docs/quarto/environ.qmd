...
the environment configuration data, the instance method `.check()` will be called on the
`Environment`.
...
Most users will be unlikely to explicitly use this function. However, if there are situations
