...
`surface_soundspeed_shear`       Shear sound speed of surface medium (m/s)
...
`surface_attenuation_shear`      Shear sound speed attenuation of surface medium (attenuation units given below)
...
env = bh.create_env2d(receiver_range=200)
...
> National Snow and Ice Data Center (comp.). 1998, updated 2006. Submarine Upward Looking Sonar Ice Draft Profile Data and Statistics, Version 1. [2000a series]. Boulder, Colorado USA. NSIDC: National Snow and Ice Data Center. https://doi.org/10.7265/N54Q7RWK. [Date accessed: 2025-10-09].
...
env = bh.create_env2d(
    ...
    surface_soundspeed_shear=1800,
    surface_density=890,
    surface_attenuation=0.4,
    surface_attenuation_shear=1.0,
