...
class TestCheckError:
    ...
    def test_check_error_fatal_error_single_line(self):
        ...
        # Should include subsequent lines
        assert '[BELLHOP] Error description' in result
    ...
    def test_check_error_fatal_error_multiple_lines(self):
        ...
        expected_lines = [
            '[BELLHOP] Generated by program or subroutine: BELLHOP',
            '[BELLHOP] Invalid input parameter',
            '[BELLHOP] Check your environment file',
    ...
    def test_check_error_fatal_error_with_context(self):
        ...
        assert '[BELLHOP] *** FATAL ERROR ***' in result
        assert '[BELLHOP] Something went wrong' in result
