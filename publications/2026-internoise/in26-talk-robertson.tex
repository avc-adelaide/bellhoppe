...
\begin{itemize}
\item \texttt{Acoustics Toolbox (Fortran)} by \textcite{porter2024-at}
\item \texttt{bellhopcpp} and \texttt{bellhopcuda} by \textcite{jaffe2025-bellhopcuda}
\end{itemize}
Competitors or other ray/beam tracers, e.g.:
\begin{itemize}
\item \texttt{TRACEO3D} by \textcite{calazan2017-traceo3d}
\item dBSea by Marshall Day Acoustics and Irwin Carr Consulting (\url{https://www.dbsea.co.uk})
\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
\frametitle{Varying surface conditions (inspired by \textcite{alexander2013-aa})}
